    ...
    <div className="space-y-6 pb-24">
      ...
      {isError && (
        <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30 text-red-300 text-sm">
          ...
          <code className="text-[#00c600]">VITE_KG_MARKETING_API_URL</code> in .env.local.
        </div>
      )}
          ...
          <div className="bg-[#2a2a2a] rounded-xl border border-[#333333] p-4 md:p-6 space-y-4">
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-full md:w-[200px] bg-[#333333] border-[#444444] text-white">
                  <Filter className="w-4 h-4 mr-2 text-[#00c600]" />

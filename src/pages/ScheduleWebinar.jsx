...
export default function ScheduleWebinar() {
  ...
  return (
    <div className="min-h-screen bg-kg-black py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-green-400 font-medium mt-2">Save days in setup • Reduce training costs by 60%</p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="border-gray-300 focus:ring-green-500 focus:border-transparent"
                  />
                </div>

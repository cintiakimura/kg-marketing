          ...
          <TableRow className="border-[#333333] hover:bg-transparent">
            <TableHead className="w-10">
              <Checkbox
                ...
                className="border-[#555] data-[state=checked]:bg-[#00c600]"
              />
            </TableHead>
        ...
        <TableBody>
          {leads.map((lead) => {
            ...
            return (
              <TableRow
                key={lead.id}
                className="border-[#333333] hover:bg-[#333333]/80 cursor-pointer"
                ...
                <TableCell className="text-white font-medium">
                  <div className="flex items-center gap-2">
                    ...
                    {isSmartFinderLead(lead) && (
                      <Sparkles className="w-3.5 h-3.5 text-[#00c600] shrink-0" title="Smart Lead Finder" />
                    )}
                  </div>
                </TableCell>
